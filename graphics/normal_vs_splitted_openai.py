...
df_original = df[['gpt-3.5-turbo', 'gpt-4o-mini', 'gpt-4o']]
df_splitted = df[['gpt-3.5-turbo Splitted', 'gpt-4o-mini Splitted', 'gpt-4o Splitted']]

# Rename columns of df_splitted to remove "Splitted"
df_splitted.columns = ['gpt-3.5-turbo', 'gpt-4o-mini', 'gpt-4o']
